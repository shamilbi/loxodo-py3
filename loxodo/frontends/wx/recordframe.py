...
class RecordFrame(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        _sz_main.Add(_ln_line, 0, wx.EXPAND|wx.RIGHT|wx.TOP, 5)
    ...
    def _add_a_passwdfield(self, parent_sizer, label, default_value):
        ...
        r_container.Add(r_masked, 1, wx.ALIGN_LEFT|wx.EXPAND, 0)
        ...
        r_container.Add(r_shown, 1, wx.ALIGN_LEFT|wx.EXPAND, 0)
